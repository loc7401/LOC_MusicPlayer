...
export default function Player() {
    ...
    return (
        <div className="screen-container magicpattern flex flex-col md:flex-row">
            <div className="w-full md:w-1/2 md:h-full h-[40%] flex items-center justify-center">
                <AudioPlayer
            ...
            <div className="w-full md:w-1/2 md:p-0 p-6 pt-8 md:h-full h-[60%] px-5 flex flex-col justify-center">
